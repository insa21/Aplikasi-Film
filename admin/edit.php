              ...
              <!-- Card body -->
               <div class="card-body">
                 <div class="custom-control custom-checkbox">
                    ...
                    <input class="custom-control-input" id="animation" name="gendre[]" type="checkbox" value="animation"
                     <?php if (in_array ('animation', $checked)) { echo "checked"; }  ?>>
                    <label class="custom-control-label" for="animation" >Animation</label>
                </div>
                 <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" id="horor" value="horor" name="gendre[]" type="checkbox" 
                    <?php if (in_array ('horor', $checked)) { echo "checked"; }  ?>>
                    <label class="custom-control-label" for="horor">Horor</label>
                  </div>
                   <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" id="romance" value="romance" name="gendre[]" type="checkbox" 
                    <?php if (in_array ('romance', $checked)) { echo "checked"; }  ?>>
                    <label class="custom-control-label" for="romance">Romance</label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" id="sci-fi" value="sci-fi" name="gendre[]" type="checkbox"
                     <?php if (in_array ('sci-fi', $checked)) { echo "checked"; }  ?>>
                    <label class="custom-control-label" for="sci-fi">Sci-fi</label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" id="adventure"value="adventure" name="gendre[]" type="checkbox"
                     <?php if (in_array ('adventure', $checked)) { echo "checked"; }  ?>>
                    <label class="custom-control-label" for="adventure">Adventure</label>
                  </div>
                  <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" id="action" value="action" name="gendre[]" type="checkbox" 
                    <?php if (in_array ('action', $checked)) { echo "checked"; }  ?>>
